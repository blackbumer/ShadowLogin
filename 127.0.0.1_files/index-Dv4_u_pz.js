...
function $4() {
    ...
    , [l]);
    const o = [{
        title: "Ғылым таппай мақтанба",
        preview: ["Ғылым таппай мақтанба.", "Орын таппай баптанба."],
        full: ["Ғылым таппай мақтанба.",
...
"Жас уақытта көңіл - гүл.",
    ...
    {
        title: "Мен жазбаймын өлеңді ермек үшін",
        preview: ["Мен жазбаймын өлеңді ермек үшін,  ", "Жоқ-барды, ертегіні термек үшін. ...."],
        full: [
...
"Қанша қызық болады өзіңізге?",
    ...
    {
        title: "Өлең — сөздің патшасы, сөз сарасы",
        preview: ["Өлең — сөздің патшасы,сөз сарасы,", "Қиыннан қиыстырар ер данасы....."],
        full: [
...
"Өтірік пен өсекті жүндей сабап.",
    ...
    {
        title: "Қалың елім, қазағым, қайран жұртым",
        preview: ["Қалың елім, қазағым, қайран жұртым,", "Ұстарасыз аузыңа түсті мұртың. ...."],
        full: [
...
"Пыш-пыш демей қала ма ол да астыртын?",
    ...
    {
        title: "Әуелде бір суық мұз— ақыл зерек",
        preview: ["Әуелде бір суық мұз— ақыл зерек,", "Жылытқан тұла бойды ыстық жүрек...."],
        full: [
...
"Ғылым сол үшеуінің жөнін білмек",
      ...
      {
        title: "Қайғы шығар ілімнен",
        preview: ["Ќайғы шығар ілімнен,", "Ыза шығар білімнен...."],
        full: [
           "Ќайғы шығар ілімнен,",
...
"Кезбе шалдан пайда жоќ.",
     ...
     {
        title: "Сабырсыз, арсыз,еріншек",
        preview: ["Сабырсыз, арсыз,еріншек,", "Көрсе қызар, жалмауыз...."],
        full: [
...
"Елдің жайы солайды.",
    ...
    {
        title: "Бойы бұлғаң",
        preview: ["Бойы бұлғаң,", "Сөзі жылмаң..."],
        full: [
            "Бойы бұлғаң,",
...
"Енді өкіндім — өзіме аз.",
     ...
     {
        title: "Интернатта оқып жүр",
        preview: ["Интернатта оқып жүр", "Талай қазақ баласы ...."],
        full: [
            "Интернатта оқып жүр",
"Талай қазақ баласы — ",
...
"Аз ақшаға жалданып",
    ...
    {
        title: "Жасымда ғылым бар деп ескермедім",
        preview: ["Жасымда ғылым бар деп ескермедім,", "Пайдасын көре тұра тексермедім."],
        full: ["Жасымда ғылым бар деп ескермедім,",
...
"Түбінде тыныш жүргенді теріс көрмедім.",
        ...
        title: "Өлең — сөздің патшасы, сөз сарасы",
        preview: ["Өлең — сөздің патшасы,сөз сарасы,", "Қиыннан қиыстырар ер данасы. "],
        full: ["Өлең — сөздің патшасы,сөз сарасы,",
"Қиыннан қиыстырар ер данасы. ",
"Тілге жеңіл, жүрекке жылы тиіп, ",
"Теп-тегіс, жұмыр келсін айналасы.",
"Бөтен сөзбен былғанса сөз арасы, ",
...
{
        title: "Сегіз аяқ",
        preview: ["Алыстан сермеп,", "Жүректен тербеп...."],
        full: [
        "Алыстан сермеп, ",
...
"                                Жалғыз қалдым — тап шыным!",
    ...
    return u.jsxs("div", {
        ...
        children: [u.jsx(gl, {}), u.jsxs("section", {
            ...
            children: u.jsxs("div", {
                ...
                children: [u.jsxs("div", {
                    ...
                    children: [u.jsx("h2", {
                        ...
                        children: "Абай Құнанбайұлының «ТОЛЫҚ АДАМ» туралы өлеңдері"
                    }), u.jsx("p", {
            ...
            className: "pt-10 fixed inset-0 z-50",
            children: [u.jsx("button", {
                type: "button",
        ...
        children: [u.jsx(gl, {}), u.jsxs("section", {
            ...
            children: [u.jsx("div", {
                ...
                children: u.jsxs("div", {
                    ...
                    children: [u.jsx("div", {
                        ...
                        className: "text-4xl md:text-6xl font-serif text-foreground",
                        children: "Асан Омаров. АБАЙДЫҢ ТОЛЫҚ АДАМ ТУРАЛЫ ІЛІМІ"
                    }), u.jsx("p", {
                        className: "text-secondary uppercase tracking-[0.2em] text-xs font-semibold",
                        children: "Абайдың «толық адам» ілімі — ақыл, жүрек және қайратты тең ұстап, адамгершілігі жоғары кемел тұлға болуға үндейтін тұжырым."
                    }), u.jsxs("p", {
            ...
            children: u.jsxs("div", {
                ...
                children: [u.jsx("div", {
                    ...
                    children: u.jsx("h2", {
                        className: "text-3xl md:text-4xl font-serif text-foreground",
                        children: "Өмір жолы мен Құдай жолы туралы түсінік"
                    })
                }), u.jsxs("p", {
                    className: "text-muted-foreground",
                    children: ["1895 жыл – Абай рухани өмірдің мөлдір бұлағына бас қойған, шабыты шалқыған алтын уақыттың бірі. Осы жылғы «Лай суға май бітпес қой өткенге» өлеңінде «Күні-түні ойымда бір-ақ Тәңірі» дей келе, нәрлі ойларын былайша тиянақтаған:", u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), u.jsxs("p", {
                        className: "text-xl text-muted-foreground leading-relaxed max-w-lg font-serif italic border-l-2 border-secondary pl-6",
                        children: ["Мекен берген, халық қылған Ол ләмәкән,", u.jsx("div", {
                            className: "pt-4 flex flex-wrap items-center gap-4 mb-0.5"
                        }), "Түп Иесін көксемей бола ма екен?", u.jsx("div", {
                            className: "pt-4 flex flex-wrap items-center gap-4 mb-0.5"
                        }), "Және Оған қайтпақсың, оны ойламай,", u.jsx("div", {
                            className: "pt-4 flex flex-wrap items-center gap-4 mb-0.5"
                        }), "Өзге мақсат ақылға тола ма екен?"]
                    }), u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), "Құдайға қайту – түп мақсат деген Құран сөзі. Өмірдің мәні, тіршіліктің сәні сонда. Бірақ оның толмай жатып солатыны бар. Өйткені, өмір жарқылы күшті, оған әлсіз пенде қайтіп қарсы тұрмақ. Ол қалың тұманда адасқан жолаушы есепті. Адаспау амалы – рухани өмір, соған ұмтыл, жетіле бер! Осынау идеяны санаға жеткізуге Абай өлең соңында тағы бір терең ой қосады:", u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), u.jsxs("p", {
                        className: "text-xl text-muted-foreground leading-relaxed max-w-lg font-serif italic border-l-2 border-secondary pl-6",
                        children: ["Өмір жолы – тар соқпақ, бір иген жақ.", u.jsx("div", {
                            className: "pt-4 flex flex-wrap items-center gap-4 mb-0.5"
                        }), "Иілтіп екі басын ұстаған Хақ.", u.jsx("div", {
                            className: "pt-4 flex flex-wrap items-center gap-4 mb-0.5"
                        }), "Имек жолда тиянақ, тегістік жоқ,", u.jsx("div", {
                            className: "pt-4 flex flex-wrap items-center gap-4 mb-0.5"
                        }), "Құлап кетпе, тура шық, көзіңе бақ!"]
                    }), u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), "Жаратқан Иеміздің өмір жолын иілтіп ұстағаны, яғни емтихан қылғаны несі? Осы түсіну маңызды. Адам ғапыл дүниені  менікі дейді, жерге неге келгенін білмейді. Тоқ кезде аштық, дені сауында ауру бар демейді. «Білмеген соқыр, Қайғысыз отыр, Тамағы тойса жатуға» (Абай).  Қиналыс, қайғы-қасірет оған ес жинатуға керек. Міне, Тәңірінің өмір жолын иілтіп ұстауы осымен өз түсінігін табады. Пендеге жаны сергек, көңілі ояу болуға өзге амал жоқ.", u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), "Қорыта айтқанда, өмір жолы – үлкенді-кішілі сынақ, оның ұңғыл-шұңғылына сүрініп, құлап кетпей, тура шығу өзіңе байланысты. Міне, Абайдың «Көзіңе бақ!» деуі – тағдырың өз қолыңда дегеннің ишараты.", u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), "Сабыр етсеңіз, енді мәселенің «адамның аты адам болуы, нағыз өмірі қай кезден?» деген аспектісіне де көңіл бөлейік.  Атың адам болуға ақыл жүрекке құлақ асуы шарт. Сонда ғана емтихан аяқталып,  нағыз өмір басталмақшы. Абайдың: «Ақылға сәуле қонбаса, Қайуанша жүріп күнелтпек» дейтіні сол.  Жұртының өзімшіл, бос сөзге үйір, ойға олақ мінездеріне ойшыл: «Жан бізді жас күнімізде билеп жүр екен. Ержеткен соң, күш енген соң, оған билетпедік. Жанды тәнге бас ұрғыздық» деп диагноз қояды.", u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), "Жанды тәнге бас ұрғызу (яки жалаң ақылмен өмір сүру) – барша адамзаттың ортақ дерті қазір. Заман адамды илегені, қақтығыс атаулы тек өрши түскені әркім өзі көріп-біліп отырған басы ашық жәйт. Берген сайын бере бер дейтін тән құмары (нәпсі) – тұтынушылық  жүгенсіз кеткен әлемде жақсылық қайдан баяндап қалсын. Әлсізді әлді, иманды пендешілік, әділетті қиянат жеңбесін, жалпақ тілмен айтқанда, жер бетіне құт дарып, бақ қонсын десек, адамзат санасы Абай діттеген бағытқа қарай өзгеруі керек.", u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), "Өмір жолы түсінігін тәпсірлеуіміз осымен тәмам.", u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), "Енді Абайдың «Құдай жолы» идеясына келейік. Құдай жолы деген – Құдайға қайту жолы. Ол жүрек көзі ашылуының, пенделіктің кәмәлатының кепілі. Яғни адам рухы мен ғайып әлем арасында байланыс орнауы деген сөз.", u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), "Осы айтылған өмірдің рухани биігіне шығып, Хақ жолында жүруді өзіне шарт қылу  – таза мұсылман, толық адам деңгейі. Ескерте отырайық, бұл санаулы тұлға еншісі. «Единица – жақсысы, Ерген елі бейне нөл» демекші, қалың тобыр етегінде қалады.", u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), u.jsx("h2", {
                        className: "text-secondary font-sans uppercase tracking-[0.2em] text-sm font-semibold mb-1.5",
                        children: "«Талай сөз бұдан бұрын көп айтқанмын» өлеңінде ұлы шайыр:"
                    }), u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), u.jsxs("p", {
                        className: "text-xl text-muted-foreground leading-relaxed max-w-lg font-serif italic border-l-2 border-secondary pl-6",
                        children: ["Адасып, алаңдама жол таба алмай,", u.jsx("div", {
                            className: "pt-4 flex flex-wrap items-center gap-4 mb-0.5"
                        }), "Берірек түзу жолға шық қамалмай.", u.jsx("div", {
                            className: "pt-4 flex flex-wrap items-center gap-4 mb-0.5"
                        }), "Не ғылым жоқ, немесе еңбек те жоқ,", u.jsx("div", {
                            className: "pt-4 flex flex-wrap items-center gap-4 mb-0.5"
                        }), "Ең болмаса кеттің ғой мал баға алмай (1895) –"]
                    }), u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-0.5"
                    }), "дейді. «Түзу жол» бұл жерде – ғылым мен өнер жолы. Ал «Тасдиқ» трактатында айтқан жол өзгерек. Ол – Жаратқан Иенің бүкіл адамзатқа салған кәмәлатты жолы. Абай: «Құдай бұл ғаламды жаратты, ерінбеді, келісімменен, хикметпенен кәмәлатты бір жолға салып жасады» дейді. Күллі тіршілік иелерінікі секілді адамзат көшінің де өзіндік кәмәлатты (әділетті) жолы бар. Ол – дамудың материалдық һәм рухани жақтары тұтас қамтылуы. Міне, даналық трактатында Абай тарқатқан түйіннің бірі осыны дәлелдеу.", u.jsx("div", {
            ...
            children: u.jsxs("div", {
                ...
                children: [u.jsx("div", {
                    ...
                    children: u.jsx("h2", {
                        className: "text-3xl md:text-4xl font-serif text-foreground",
                        children: "Толық адам және әділетті жол идеясы"
                    })
                }), u.jsxs("p", {
                    className: "text-muted-foreground",
                    children: [u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), "«Тасдиқ» трактатында кәмәлатты (әділетті) жолға қатысты Абай екі анықтама береді: бірі – «Не түрлі болса да, я дүниеңнен, я ақылыңнан, я малыңнан, ғадаләт, шапағат секілді біреулерге жақсылық тигізбек мақсатың болса, ол жол – Құданың жолы». Екіншісі –  «Құдай жолы – шексіз. Бірақ сол жолға жүруді өзіне шарт қылып кім қадам басты, ол – таза мұсылман, толық адам делінеді». Тезистің екеуі де маңызды анықтама, әрі ереже!", u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), "Сонымен, Құдай жолы – әділетті жол, оған жүруді өзіне шарт қылып қадам басты, сол – таза мұсылман, толық адам. Болды, бітті. Егерде толық адам концепциясын Құдай жолы ұғымынан бөлек қарастырсақ, онда бәһра болмайды, жаңсақтыққа ұрынамыз.", u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), "Енді Абайдың: «Құдай тағаланың жолы деген жол ниһаятсыз (шексіз) болады. Оның ниһаятына ешкім жетпейді» деген сөзіне назар аударайық. Фәни өмір де, адамның өмірі де шектеулі. Демек, ойшылдың «Құдай жолы шексіз» дегені – рухани әлемді меңзегені. Заттық әлем – өткінші, бақи – мәңгі. Сөйтіп, екі жол бар:  бірі – дүниелік жол, ол – қысқа әрі адамды уақыт өткен сайын Тәңіріден алшақтата береді, екіншісі – рухани жол (яғни ғұмыр), ол – шексіз әрі Тәңіріге жақындата түсетін болады.", u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), "Тағы айтайық, шексіз де әділетті жол – нәпсіні жеңгендердің және біреулерге жақсылық тигізбекті мақсат қылғандардың жолы. Мәселен, Құранда: «Сондай жолымызды қалағандарды, әлбетте, тура жолымызға саламыз» (Ғанкабут сүресі, 69-аят) делінген", u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), u.jsx("h2", {
                        className: "text-secondary font-sans uppercase tracking-[0.2em] text-sm font-semibold mb-1.5",
                        children: "Әділет және әділетті жол сөз болған жерде «Алланың өзі де рас...» өлеңінде Абай айтқан:"
                    }), u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), u.jsxs("p", {
                        className: "text-xl text-muted-foreground leading-relaxed max-w-lg font-serif italic border-l-2 border-secondary pl-6",
                        children: ["Адамзаттың бәрін сүй бауырым деп,", u.jsx("div", {
                            className: "pt-4 flex flex-wrap items-center gap-4 mb-0.5"
                        }), "Және Хақ жолы осы деп әділетті, -"]
                    }), u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), "деген даналық идеяны айналып өте алмаймыз.", u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), "Кешегі кеңестік дәуірде үшінші сүю – әділетті сүю деп келдік.    Абайдың «Махаббатпен жаратқан адамзатты» дегені – бірінші сүю, Алланың адамды сүюі екені ескерілмеді. Ақиқатында Абай Хақ жолын айтқан, оның маңызын, не үшін керектігін діттеген. Онсыз баршаға сүйіспеншілікпен қарау жоқ. Жалған өмір жолындағы адамға бұл бос қиял есепті. Керісінше, Құдай жолына қадам басқан ғадаләтті адамға бұл қалыпты нәрсе.", u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), "Ғадаләтті болу – баршаға махаббатпен қарау дегенді ойшыл былайша түсіндіреді: «Ғадаләтті адамның көңіліне келеді: мен өз көңілімде «Халлақы менімен, сондай-мұндай халықтарымен (жаратқандарымен) мұғамәла (мәміле, жылы қарым-қатынас) қылса екен» деп тұрып, өзім сол халықтармен мұғамәла қылмағандығым жарамайды ғой деп».", u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), "Сөйтіп, «Және Хақ жолы осы деп әділетті» дегеннің мәнісі – әділетті сүю емес. Адамзатты, бір жағынан, «бауырым» деп, екінші жағынан, «Алланың барша пенделеріне салған кәмәлатты жолы осы» деп сүю. Осылай түсінсек дұрыстық.", u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), "Баршаны кәмәлатқа, Құдай жолына шақырған хакім: «Өзге жолда не үміт бар?» дейді. Кәмәлатты жол – шексіз, демек, онда алдыңғы, ортаңғы және артқы топтар болмақ. Баршасына үш қасиет (ғылым, рахым, ғадаләт) ортақ. «Бұл айтылмыш үш хасләт иелерінің алды – пайғамбарлар, онан соң – әулиелер, онан соң – хакімдер, ең ақыры – кәміл мұсылмандар» (Абай).", u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), "Аталған төрт топ өкілдері, әрине, көктен салбырап түспейді, саналы жандар мен Тәңіріге мойынсұнған қарапайым діндар қауым арасынан шықпақшы. Ислам теориясы бойынша өмір жолынан Хақ жолына басқыштаған иманы түгел тұлға «кәміл адам» (парасатты я саналы адам) делінеді. Онан толық адамның айырмасы неде? Енді осыған тоқталайық.", u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-7.5"
                    })]
                })]
            })
            ...
            children: u.jsxs("div", {
                ...
                children: [u.jsx("div", {
                    ...
                    children: u.jsx("h2", {
                        className: "text-3xl md:text-4xl font-serif text-foreground",
                        children: "Толық адам  мен кәміл адам: бірлігі мен  өзгешелігі"
                    })
                }), u.jsx("p", {
                    className: "text-muted-foreground",
                    children: "Кәміл адам (әл-инсан әл-камил) деп мұсылмандық Шығыстың фәлсафасында рухани болмысын жетілдірген кәмәлатты тұлғаны айтқан. Абай үйреншікті түрде «кәміл адам» демей, «толық адам» деген. Неге? Бұл, сөз жоқ, «мен өзімнің төл танымым бойынша өзіндік бейнені қалыптадым» деген ишараты. Сонымен, ескі мен жаңаның бірлігі неде, өзгешелігі қайсы?"
                }), u.jsx("div", {
                    className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                }), u.jsx("h2", {
                    className: "text-secondary font-sans uppercase tracking-[0.2em] text-sm font-semibold mb-1.5",
                    children: "Алдымен ортақ қасиеттеріне тоқталайық. «Әуелде бір суық мұз – ақыл зерек» өлеңінде Абай былай дейді:"
                }), u.jsx("div", {
                    className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                }), u.jsxs("p", {
                    className: "text-xl text-muted-foreground leading-relaxed max-w-lg font-serif italic border-l-2 border-secondary pl-6",
                    children: ["Ақыл, қайрат, жүректі бірдей ұста,", u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-0.5"
                    ...
                    children: [u.jsx("div", {
                        ...
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), "Өйткені, бірдей ұстау – нәпсіні жеңу. Шәкәрім: «Мына жақта нәпсі жатыр, Қиянатты жастанып» демекші, кәне, ол «батырды» жеңіп көр. Өле-өлгенше өзіңмен күресуің керек. Бұл, әрине, сирек тақуа данышпанның ғана сыбағасы.", u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), "Қорыта айтқанда, кәміл, мейлі, толық адам дейік, бұлар – Құдай жолына қадам басқандар. Екеуі де заманға билетпей, қайта оны билейтін, жаңа айтылғандай, адамдық үш қасиетті бірдей ұстау жөніменен өмірден ғұмырға сатылаған жандар. Жанасатын тұстары көп болуы да содан.", u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), "Негізі, Абай, Шәкәрімнің ғұмыры кәмәлаттың жарқын мысалы. Екі ғұлама да артқыға өлмес, өшпес ілімдерін қалдырды. Бұл өмірлік сабақ, дүниелік тәжірибенің арқасы. Жалғанның көрешегін кеше жүріп, өмір жолынан Хақ жолына сатылаудың үлгі, өнегесі.", u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), "Енді кәміл адам мен толық адамның өзгешелігі неде дегенге келейік. Бірден айтайық, ол өзгешелік – Құдайға ғашықтық деңгейі екі түрлі болуына тіреледі. Кәміл адам – орта ғасырлар көлемінде имам әл-Ғазали, әзіреті Иасауи бастатқан мұсылман ғұламалары дүниеге әкелген сопылық теориясы. Ол бойынша кім Құдай жолы – тариқатқа кірсе, сол кәмәлатқа жетпекші. Оған нәпсіден суынып, ахирет пайдасын күзетсе жеткілікті, өмір жолынан өту шарт емес. Бұл – бек шетін, бек нәзік әулиелік жол. Оған ғылымның да, қайраттың да, махаббаттың да зоры керек. Сондықтан оған түссем дейтіндерге Абай: «Әрбір наданның «біз тарихатқа кірдік»  деп жүргені «біз бұзылдық» дегеніменен бір болады» деп ескерту жасайды.", u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), "Сонымен, өзгешелік неде? Абай әулиелер хақында: «Олар ухраи (ахирет) пайдасын ғана күзетті. Ғашықтықтары сол хәлге жетті, дүниені, дүниедегі тиерлік пайдасын ұмытты» десе, хакімдер туралы: «Хакімдер дүниеде тиетін пайдасын сөйледі. ...Дүниедегі бүкіл ләззат бұларға екінші мәртабада қалып, бір ғана Хақты таппақ, әрбір нәрсенің себебін таппақпенен ләззаттанады» дейді.", u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), "Осы екі анықтама біз іздеп отырған кәміл инсан мен толық адам айырымына да сәулесін түсіреді. Хакім жайлы сөзден ұғылатыны – бұлар Құдайға деген махаббаты мен құлшылығын дүние ісі арқылы атқаратындар («Бір ғана Хақты таппақ, әрбір нәрсенің себебін таппақпенен ләззаттану» Абайдың өзінің де тәжірибесі).", u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), u.jsx("h2", {
                        className: "text-secondary font-sans uppercase tracking-[0.2em] text-sm font-semibold mb-1.5",
                        children: "Өмір, дүние ісі арқылы Құдай тағала разылығына бөленудің амалы –   жасампаздық, ізгілік жасаушылық. Ізгілік жасау (ғамалус-салих) не екенін Абай былай деп жеткізеді:"
                    }), u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), u.jsxs("p", {
                        className: "text-xl text-muted-foreground leading-relaxed max-w-lg font-serif italic border-l-2 border-secondary pl-6",
                        children: ["Мазлұмға жаның ашып, ішің күйсін,", u.jsx("div", {
                            className: "pt-4 flex flex-wrap items-center gap-4 mb-0.5"
                        }), "Харекет қыл, пайдасы көпке тисін.", u.jsx("div", {
                            className: "pt-4 flex flex-wrap items-center gap-4 mb-0.5"
                        }), "Көптің қамын әуелден Тәңірі ойлаған,", u.jsx("div", {
                            className: "pt-4 flex flex-wrap items-center gap-4 mb-0.5"
                        }), "Мен сүйгенді сүйді деп Иең сүйсін! (1897)."]
                    }), u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), "Қорыта айтқанда, хакім Абай көміліп қалған жәуәнмәртлік пен кәміл адам ілімдерін қазып алып, қайта тірілткен. Осыған көз жеткіздік. Қайта жаңғырған ілім бойынша, пенделіктің кәмәлаты екі тараптан: бірі – иман, көкірек көздің ашылуы, екіншісі – ихсан, дүниеге тиетін пайдасын ойлау, ізгілікті көп жасауға ұмтылу. Кәмәлат биігіне көтерілудің қос қанаты, міне, осылар десек, бұл тұжырымға ешкімнің таласы бола қоймас деген ойдамын.", u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-7.5"
                    })]
                })]
            })
            ...
            children: u.jsxs("div", {
                ...
                children: [u.jsx("div", {
                    ...
                    children: u.jsx("h2", {
                        className: "text-3xl md:text-4xl font-serif text-foreground",
                        children: "АБАЙДЫҢ ҮШ СҮЮ ІЛІМІ"
                    })
                }), u.jsxs("p", {
                    className: "text-muted-foreground",
                    children: [u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), "Дана Абай: «Осы үш сүю болады иманигүл» дейді («Алланың өзі де рас, сөзі де рас» өлеңі). Иманигүл – қазақта бұрын-соңды айтылмаған тосын сөз, ол – «толық (түгел) иман» дегенді, метафорамен бейнелесек, «Хош иісті гүлдей Алланың сүйіктісі бол» деген мән-мағынаны білдіреді. Ол – Құдайға махаббаттың символы, әрі ес-ақылдың шыңы:", u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), u.jsxs("p", {
                        className: "text-xl text-muted-foreground leading-relaxed max-w-lg font-serif italic border-l-2 border-secondary pl-6",
                        children: ["Осы үш сүю болады имани гүл,", u.jsx("div", {
                            className: "pt-4 flex flex-wrap items-center gap-4 mb-0.5"
                        }), "Иманның асылы үш деп сен тахқиқ  біл.", u.jsx("div", {
                            className: "pt-4 flex flex-wrap items-center gap-4 mb-0.5"
                        }), "Ойлан-дағы, үшеуін таратып бақ,", u.jsx("div", {
                            className: "pt-4 flex flex-wrap items-center gap-4 mb-0.5"
                        }), "Басты байла жолына, малың түгіл."]
                    }), u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), "Міне, үш сүюдің маңызы қандай! Үш сүю, мейлі, иманигүл дейік, өте күрделі ілім, бек шетін, бек нәзік жол. Сондықтан оның мағынасына жету үшін алдымен жүрек көзі, жүрек тазалығы ұғымдарын ізерлеп өткенді жөн санадық.", u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), u.jsx("h2", {
                        className: "text-secondary font-sans uppercase tracking-[0.2em] text-sm font-semibold mb-1.5",
                        children: "Жүрегіңе сүңгі де, түбін көзде…"
                    }), u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), "Хақ тағала күллі ғаламды махаббатпен жаратқан, оның керек емес жері жоқ, кіріспейтұғын да жері жоқ. Сол илаһи махаббат – жүректің де басты қасиеті. Сол себепті  Абай: «Тірі адамның жүректен аяулы жері бар ма?» дейді. Бұл сөзді ет жүрек, жау жүрек, жаралы жүрек, жамау жүрек, жылы жүрек, ыстық жүрек, ынталы жүрек дегендей сан алуан мағынада жиі қолданған. «Атың адам болуға жүректі тыңда, оған құлақ ас!» деген тәлім береді.", u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
                    }), "Тоқ етері, хакімнің иманға һәм адамшылық тәрбиеге қатысты көзқарастарын жіті танып-білудің кілті – жүрек болып табылады.", u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-1.5"
            ...
            children: u.jsxs("div", {
                ...
                children: [u.jsx("div", {
                    ...
                    className: "text-xl text-muted-foreground leading-relaxed max-w-lg font-serif italic border-l-2 border-secondary pl-6",
                    children: ["Өлеңнің әйгілі бесінші шумағы мынау:", u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-0.5"
                    }), "Махаббатпен жаратқан адамзатты,", u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-0.5"
                    }), "Сен де сүй Ол Алланы жаннан тәтті.", u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-0.5"
                    }), "Адамзаттың бәрін сүй бауырым деп,", u.jsx("div", {
                        className: "pt-4 flex flex-wrap items-center gap-4 mb-0.5"
                    }), "Және Хақ жолы осы деп әділетті."]
                }), u.jsxs("p", {
                    className: "text-muted-foreground",
