...
const translations = {
    ru: {
        ...
        feedback: {
            ...
            name: 'Имя',
            namePlaceholder: 'Ваше имя (демо)',
            email: 'Email (демо)',
            emailPlaceholder: 'вы@example.com',
            message: 'Ваш отзыв',
            messagePlaceholder: 'Что вы думаете о ShadowLogin...',
            send: 'Отправить отзыв (демо)',
            submitted: '✓ Отзыв отправлен (демо)'
        },
        rate: {
            title: 'Оцените нас',
            ...
            thanks: 'Спасибо за оценку (демо)'
        },
        support: {
            title: 'Техническая поддержка (Демо)',
            ...
            placeholder: 'Введите сообщение (демо)',
            send: 'Отправить',
    ...
    kk: {
        ...
        generator: {
            ...
            fieldEmail: 'Демо электрондық пошта',
        ...
        feedback: {
            ...
            name: 'Атауы',
            namePlaceholder: 'Сіздің атыңыз (демо)',
            email: 'Электрондық пошта (демо)',
            emailPlaceholder: 'сіз@example.com',
            message: 'Сіздің пікіріңіз',
            messagePlaceholder: 'ShadowLogin туралы сіз не ойлайсыз...',
            send: 'Пікір жіберу (демо)',
            submitted: '✓ Пікір жіберілді (демо)'
        },
        rate: {
            ...
            thanks: 'Баға бергеніңіз үшін рахмет (демо)'
        },
        support: {
            title: 'Техникалық қолдау (Демо)',
            desc: 'Бұл демо чат интерфейсі ShadowLogin пайдалану туралы сұрақтар қоя алатын пайдаланушылар үшін қолдау арнасын имитациялайды. Барлық хабарламалар жергіліктіде қалады және бот консервіленген, білімді ответтерінің берейді.',
            hello: 'Сәлем! Бұл демо қолдау боты. Мен сізге қалай көмектесе алам?',
            placeholder: 'Хабарламаны енгізіңіз (демо)',
            send: 'Жіберу',
            reply: 'Бұл демо жауап. Өмір ішіндегі қолдау үшін, команданы хабарласыңыз.'
        },
        about: {
            title: 'Туралы',
        ...
        whatWeDo: {
            ...
            feature2: 'Құпиялық деңгейін реттеу және демо құпиялық ұпайын бақылау.',
            feature3: 'Панель статистикасы және әрекет журналдарымен өмір ұзақтығын қадағалау.',
            feature4: 'Сынау процесінің бөлігі ретінде демо аккаунттарды ортақтау немесе деактивациялау.',
            feature5: 'Бағалау үшін пікір мен рейтингтерді жергіліктіде жинау.'
        },
        whatsNew: {
            title: 'Жаңа',
            desc: 'Бұл кеңейтілген шығарымындағы соңғы жаңартулар көп түрлі аккаунт құрастыруды, төмендетілген басқару панелін, мобильдік құрылғыға төзімділік, демо чатты және төмендетілген құпиялық есептеуді қамтиды. Бұл өзгерістер білім беру құндылығын терендетеді және демонстрацияны сценарий ортасы үшін орынды істейді.',
